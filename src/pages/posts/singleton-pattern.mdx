...
import SampleCodes1 from '@sample-codes/singleton-pattern/1/data.ts';
import SampleCodes2 from '@sample-codes/singleton-pattern/2/data.ts';
import SampleCodes3 from '@sample-codes/singleton-pattern/3/data.ts';
...
<Video controls="" autoPlay src="/public/videos/singleton-1.webm" />
...
<Video controls="" autoPlay src="/public/videos/singleton-2.webm" />
...
<Editor testMode client:idle files={SampleCodes3} />
...
<Editor testMode client:idle files={SampleCodes4} />
